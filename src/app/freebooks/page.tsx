    ...
    <div className="bg-gray-50">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">Fashion E-books Collection</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden group transform transition duration-300 hover:scale-105">
              <div className="h-64 bg-gray-300 rounded-t-lg flex items-center justify-center">
                <span className="text-white text-4xl font-semibold">Fashion Trends</span>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900">Fashion Trends: A Beginner&#39;s Guide</h3>
                <p className="mt-2 text-gray-600">
                  Learn the basics of fashion, essential styles and trends, and how to create your first stylish outfit.
                </p>
                <a
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden group transform transition duration-300 hover:scale-105">
              <div className="h-64 bg-gray-300 rounded-t-lg flex items-center justify-center">
                <span className="text-white text-4xl font-semibold">Seasoning</span>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-900">The Art of Seasoning</h3>
                <p className="mt-2 text-gray-600">
                  Discover the secrets behind seasoning outfits for different seasons and occasions.
                </p>
                <a
