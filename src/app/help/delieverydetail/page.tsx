        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 text-center">
              ...
              <p className="mt-4 text-gray-600">Orders within the country will be delivered within 4-5 business days after processing.</p>
            </div>
            {/* International Delivery */}
            <div className="bg-white shadow-lg rounded-lg p-6 text-center">
              <h3 className="text-xl font-semibold text-indigo-600">International Delivery</h3>
              <p className="mt-4 text-gray-600">For international shipping, delivery times range from 7-15 business days depending on location.</p>
            </div>
            {/* Expedited Shipping */}
            <div className="bg-white shadow-lg rounded-lg p-6 text-center">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="text-center">
            <a
              href="#"
              className="py-3 px-6 bg-gray-600 text-white rounded-lg hover:bg-gray-800 transition"
            >
              Track Order
            </a>
          </div>
...
export default DelieveryDetailsPage;