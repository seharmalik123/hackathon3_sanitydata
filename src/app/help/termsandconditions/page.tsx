          ...
          <div className="space-y-6">
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600">
                Welcome to our website wardrobewonder! These terms and conditions govern your access to and use of our website. By browsing or using our services, you agree to be bound by these terms.
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600">
                All content on this website, including text, images, and logos, are the property of wardrobewonder and are protected by intellectual property laws. You may not use any content without prior written consent from us.
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600">
                These Terms and Conditions shall be governed by and construed in accordance with the laws. Any disputes will be resolved in the court.
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600">
                If you have any questions or concerns regarding these Terms and Conditions, please contact us at <a href="mailto:support@wardrobewonder.com" className="text-indigo-600">support@wardrobewonder.com</a>.
              </p>
            </div>
          </div>
        </div>
