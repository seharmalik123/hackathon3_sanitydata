        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 text-center">
              ...
              <p className="mt-4 text-gray-600">For inquiries, reach us via email at:</p>
              <a href="mailto:support@yourcompany.com" className="mt-4 inline-block text-gray-600 underline">
                support@shop.co
              </a>
            </div>
            {/* Phone */}
            <div className="bg-white shadow-lg rounded-lg p-6 text-center">
              <h3 className="text-xl font-semibold text-gray-400">Phone Support</h3>
              <p className="mt-4 text-gray-600">Call us at our customer care line:</p>
              <p className="mt-4 text-gray-800 text-xl">+1 (600) 123-4567</p>
            </div>
            {/* Live Chat */}
            <div className="bg-white shadow-lg rounded-lg p-6 text-center">
              <h3 className="text-xl font-semibold text-indigo-600">Live Chat</h3>
              <p className="mt-4 text-gray-600">Need immediate assistance? Chat us live:</p>
              <a
                href="#"
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <form className="bg-white shadow-lg rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="name" className="block text-gray-900 font-semibold">Name</label>
              <input
                type="text"
                id="name"
                name="name"
            ...
            <div className="md:col-span-2">
              <label htmlFor="message" className="block text-gray-900 font-semibold">Message</label>
              <textarea
                id="message"
                name="message"
                rows={4}
            ...
            <div className="md:col-span-2 text-center">
              <button
                type="submit"
                className="py-3 px-6 bg-black text-white rounded-lg hover:bg-gray-700"
              >
                Send Message
              </button>
            </div>
