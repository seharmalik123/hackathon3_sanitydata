          ...
          <div className="space-y-6">
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600">
                At Wardrobewonder, we value your privacy. This privacy policy explains how we collect, use, disclose, and protect your personal data when you visit our website or use our services.
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600">
                ...
                You can manage your cookies preferences through your browser settings.
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600">
                ...
                To exercise these rights, please contact us at <a href="mailto:support@wardrobewonder.com" className="text-indigo-600">support@wardrobewonder.com</a>.
              </p>
            </div>
            <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <p className="mt-2 text-gray-600">
                If you have any questions or concerns about this Privacy Policy or how we handle your data, please contact us at <a href="mailto:support@wardrobewonder.com" className="text-indigo-600">support@wardrobewonder.com</a>.
              </p>
            </div>
          </div>
        </div>
